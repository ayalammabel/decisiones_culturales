...
var style_SubndicedeEquidaddeGneroyEliminacindelMachismoporBarrio_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("indice_intervencion");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.097121 && value <= 0.318560) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.318560 && value <= 0.333156) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.333156 && value <= 0.344463) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.344463 && value <= 0.360570) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.360570 && value <= 0.476602) {
            style = [ new ol.style.Style({
